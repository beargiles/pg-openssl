...
Once openssl is installed, you can add it to a database. If you're running
PostgreSQL 9.1.0 or greater, it's a simple as connecting to a database as a
super user and running:

    CREATE EXTENSION openssl;

If you've upgraded your cluster to PostgreSQL 9.1 and already had openssl
...
If you want to install openssl and all of its supporting objects into a specific
